modded class LoadingScreen {
	...
	void LoadingScreen(DayZGame game) {
		...
		m_ImageBackground.LoadImageFile(0, "MocM/gui/data/Load2_co.edds");
...
modded class LoginQueueBase {
	...
	override Widget Init() {
		...
		imageWidgetBackground.LoadImageFile(0, "MocM/gui/data/LoadMoc1.edds");
		return w;
	}
}
...
modded class LoginTimeBase {
	...
	override Widget Init() {
		...
		ImageWidget imageWidgetBackground = ImageWidget.Cast( layoutRoot.FindAnyWidget("Background") );
		imageWidgetBackground.LoadMaskTexture("");
		imageWidgetBackground.LoadImageFile(0, "MocM/gui/data/Load2_co.edds");
		return w;
	}	
}